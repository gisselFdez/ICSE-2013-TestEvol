...
public class TestCoverageDriver {
  ...
  public static void instrument(String basedir, File datafile, String destination, List<String> ignore,
    List<String> includeClasses, List<String> excludeClasses, List<String> instrument, TrexClassLoader classLoader)
  ...
  private static void main(TrexClassLoader clsLoader, String className, String[] params)
